<?php
	...
	switch ($act) {
		default:
			...
			?>
			<!-- The mulyaal -->
			<div id="id01" class="w3-mulyaal">
			  <div class="w3-mulyaal-content">
			...
			<!-- The mulyaal -->
			<div id="id02" class="w3-mulyaal">
			  <div class="w3-mulyaal-content" style="width: 35%;">
			    <div class="w3-container">
		...
		case "printout" :
			...
			if(isset($_GET['id']))
			{
				...
				<p>
				    ...
				    <a href='mulya=penjualan&act=editqty' class='w3-btn w3-dark-gren w3-tiny' ><i class='fa fa-pencil-square'></i> Edit</a>
				...
				if($fd_kul > 0)
				{
					...
					while ($m = mysql_fetch_assoc($sql_kul)) {
						...
						echo"<tr>
							...
							<a href='$aksi?mulya=penjualan&act=editqty' class='w3-text-blue' onclick=\"document.getElementById('id01').style.display='block'\">Edit Transaksi</a>
